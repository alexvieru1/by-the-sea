  ...
  return (
    ...
    >
      <div className="mx-auto flex h-full min-h-screen max-w-7xl flex-col items-center px-6 lg:flex-row lg:items-stretch lg:px-12">
        ...
        <motion.div
          className="z-10 flex w-full items-center py-12 lg:w-1/2 lg:py-24"
          style={{ x: cardX, opacity: cardOpacity }}
        >
          <div className="w-full max-w-lg rounded-3xl bg-[#f07060] p-8 shadow-2xl lg:p-12">
        ...
        {/* Right side - Image with scanning effect */}
        <div className="relative flex w-full items-center justify-center lg:w-1/2">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-[#d4c4c0] to-[#c5b5b1]" />
            
            {/* Scanning dots overlay effect */}
            <div className="absolute inset-0 overflow-hidden">
              {/* Animated scanning line */}
              <motion.div
                className="absolute left-0 h-1 w-full bg-gradient-to-r from-transparent via-white/40 to-transparent"
                animate={{
                  top: ['0%', '100%', '0%'],
                }}
                transition={{
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-[#f07060]/20 to-transparent" />
              </motion.div>
            </div>
          </motion.div>
        </div>
