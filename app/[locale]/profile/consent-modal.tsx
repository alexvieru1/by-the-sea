  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="mx-4 w-full max-w-md bg-white p-8">
        <h2 className="mb-2 font-[family-name:var(--font-playfair)] text-2xl font-normal italic text-gray-900">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <label htmlFor="modal-gdpr" className="cursor-pointer text-sm text-gray-700">
              {t('gdprConsent')}{' '}
              <Link href="/privacy" className="text-[#0097a7] underline" target="_blank">
                {t('gdprLink')}
              </Link>
            </label>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <label htmlFor="modal-terms" className="cursor-pointer text-sm text-gray-700">
              {t('termsConsent')}{' '}
              <Link href="/terms" className="text-[#0097a7] underline" target="_blank">
                {t('termsLink')}
              </Link>
            </label>
          </div>
        ...
        <button
          ...
          className="mt-8 w-full bg-[#0097a7] px-8 py-4 text-sm font-medium uppercase tracking-wider text-white transition-colors hover:bg-[#00838f] disabled:opacity-50"
        >
