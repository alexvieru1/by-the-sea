...
export default function SignupPage() {
  ...
  const lockedPhone =
    rawPhone && ROMANIAN_PHONE_REGEX.test(rawPhone) ? rawPhone : null;
  const prefillPhone = lockedPhone ?? "";
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              />
              {lockedPhone && (
                <p className="mt-1 text-xs text-gray-500">{t("phoneLocked")}</p>
              )}
              {errors.phone && (
                <p className="mt-1 text-xs text-red-600">
